...
class UserCalendars extends React.Component {
  ...
  render() {
    ...
    const introductionTextFragment = disableCalendarImport ? 
        <><Text as="p">
          It is possible to import <Text weight="bold">University of Oxford Term dates</Text> into your Canvas calendar. <Link target='_top' href={globalCalendarLink}>Access your Calendar via the Global Navigation menu</Link>. Alongside <Text weight="bold">Other Calendars</Text> click the ‘+’ sign and then select and save the option <Text weight="bold">University of Oxford</Text>. There is detailed guidance on how to do this in the Canvas guides for <Link target='_blank' href='https://canvas.ox.ac.uk/courses/12009/pages/adding-university-term-names-and-week-numbers-to-your-calendar?module_item_id=2117372'>staff</Link> and for <Link target='_blank' href='https://canvas.ox.ac.uk/courses/21629/pages/the-calendar?module_item_id=2098258#section2'>students</Link>.
        </Text>
        <Alert variant="warning">
          If you have previously imported the 2022/23 and/or 2023/24 University of Oxford terms and weeks into your personal Canvas calendar (via an earlier version of the tool), deselect the relevant toggle button(s) to remove them. (Otherwise they will appear in your calendar twice.)
        </Alert></>
        :
