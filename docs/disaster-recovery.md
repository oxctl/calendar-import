...
5. Once any changes have been comitted and pushed to the remote branch, GitHub Actions will start the build automatically (provided the branch name starts with `dr-`). You can check progress https://github.com/oxctl/calendar-import/actions
