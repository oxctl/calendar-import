 ...
 * {@link GrantedAuthority} that are specified by {@link #roles()}.
 * </ul>
 *
 * @see WithUserDetails
 *
...
@Inherited
@Documented
@WithSecurityContext(factory = WithMockClaimsSecurityContextFactory.class)
public @interface WithMockClaims {
	/**
	...
	/**
	 * The account ID the user is using the API from.
	 */
	String accountId() default "";

	/**
	 * A JSON String that will become the claims on this object
	 */
