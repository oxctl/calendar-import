...
public class UserTokensRepositoryTest {
    ...
    public static final TenantAndPrincipal TENANT_AND_PRINCIPAL = new TenantAndPrincipal("tenant", "principal");
    @Autowired
    ...
    public void testSaveLoadEmpty() {
        ...
        {
            UserTokens userTokens = repository.findById(TENANT_AND_PRINCIPAL).orElseThrow(() -> new AssertionError("Failed to find UserTokens"));
