 ...
 *
 * <ul>
 *   <li>The {@link SecurityContext} created with be that of {@link
 *       SecurityContextHolder#createEmptyContext()}
 *   <li>It will be populated with an {@link UsernamePasswordAuthenticationToken} that uses the
 *       username of either {@link #value()} or {@link #username()}, {@link GrantedAuthority} that
 *       are specified by {@link #roles()}, and a password specified by {@link #password()}.
 * </ul>
 *
 * @see WithUserDetails
 * @author Rob Winch
...
@Inherited
@Documented
@WithSecurityContext(factory = WithMockLtiUserSecurityContextFactory.class)
public @interface WithMockLtiUser {
  /**
   ...
   *
   * <p>If {@link #authorities()} is specified this property cannot be changed from the default.
   *
   * @return
   */
   ...
   *
   * <p>If this property is specified then {@link #roles()} is not used. This differs from {@link
