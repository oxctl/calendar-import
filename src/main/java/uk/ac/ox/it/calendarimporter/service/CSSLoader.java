 ...
 * cacheable in the future. This currently isn't needed as we are just changing the JSON URL
 * into a CSS URL to load the brand CSS, but if that stops working we can switch back to this.
 */
@Service
